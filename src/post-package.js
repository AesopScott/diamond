...
export function createPostPackage(input = {}) {
  ...
  return {
    ...
    campaignGuidanceSummary: cleanText(input.campaignGuidanceSummary),
    status,
...
export function createPlatformDraft(input = {}) {
  ...
  return {
    ...
    brandGuidanceModules: Array.isArray(input.brandGuidanceModules) ? input.brandGuidanceModules : [],
    brandGuidanceSummary: cleanText(input.brandGuidanceSummary || postPackage.brandGuidanceSummary),
    campaignGuidanceModules: Array.isArray(input.campaignGuidanceModules) ? input.campaignGuidanceModules : Array.isArray(postPackage.campaignGuidanceModules) ? postPackage.campaignGuidanceModules : [],

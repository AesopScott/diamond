...
export function createSeedWorkspace() {
  ...
  return {
    ...
    brandGuidanceModules: [
      {
        id: "the-card-brandvoice",
        brandId: context.brandId,
        key: "brandVoice",
        title: "Voice",
        source: "brandLibrary",
        valueType: "text",
        enabled: true,
        content: "Sharp, plainspoken, sports-smart, and useful. Speak as thecard.bet, not Aesop Academy.",
        sortOrder: 1,
      },
      {
        id: "the-card-approvedphrases",
        brandId: context.brandId,
        key: "approvedPhrases",
        ...
        valueType: "list",
        enabled: true,
        content: "free World Cup league\nmake your picks\nleaderboard\nthecard.bet",
        sortOrder: 2,
      },
      {
        id: "the-card-bannedphrases",
        brandId: context.brandId,
        key: "bannedPhrases",
        ...
        valueType: "list",
        enabled: true,
        content: "guaranteed win\nrisk-free profit\nAesop Academy",
        sortOrder: 3,
      },
      {
        id: "the-card-prizelanguage",
        brandId: context.brandId,
        key: "prizeLanguage",
        title: "Prize language",
        source: "claimLibrary",
        valueType: "list",
        enabled: true,
        content: "$1,000 total payouts\n$500 to the winner\n$250 to the runner-up\n$100 to third place\n$50 for fourth through sixth",
        sortOrder: 4,
      },
      {
        id: "the-card-freetoplaylanguage",
        brandId: context.brandId,
        key: "freeToPlayLanguage",
        title: "Free-to-play language",
        source: "claimLibrary",
        valueType: "list",
        enabled: true,
      ...
      {
        id: "the-card-requiresreviewclaims",
        brandId: context.brandId,
        key: "requiresReviewClaims",

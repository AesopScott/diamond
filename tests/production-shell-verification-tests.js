...
assert.match(preload, /clearAccountSession/);
...
assert.match(main, /diamond:clear-account-session/);
assert.match(main, /clearStorageData/);
assert.match(main, /cachestorage/);
...
assert.match(html, /disabled title="Analytics filters land after the default shell flip\."/);
